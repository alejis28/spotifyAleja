...
.then(function(respuesta){
    ...
    .then(function(respuesta){
        ...
        imagen3.src=respuesta.tracks[0].album.images[0].url
        ...
        imagen4.src=respuesta.tracks[0].album.images[0].url
        ...
        imagen5.src=respuesta.tracks[0].album.images[0].url
        ...
        imagen6.src=respuesta.tracks[0].album.images[0].url
        ...
        imagen7.src=respuesta.tracks[0].album.images[0].url
        ...
        imagen8.src=respuesta.tracks[0].album.images[0].url
        ...
        imagen9.src=respuesta.tracks[0].album.images[0].url
        ...
        imagen10.src=respuesta.tracks[0].album.images[0].url
